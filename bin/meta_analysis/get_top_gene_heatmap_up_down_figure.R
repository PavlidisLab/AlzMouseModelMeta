...
#' updated 2016-08-03 for figure quality and combine up and down regulated in 1 figure
#' ################################################################################################
    ...
    # get the top up and down gene list
        ...
        for (disease_phase in phase_ls){
            ...
            for (i in 1:length(f_ls)){
                ...
                (plotdir <- paste0(plotdir_1, '/all_probes/', disease_phase,"_", keyword, "/"))
                if(low_exp_rm){
                    (plotdir <- paste0(plotdir_1, '/low_exp_rm/', disease_phase,"_", keyword,"/"))
                }
                ...
                ################################
                (plt_title <- paste0(dataset_p, "_top_regulated_", keyword))
                (plot_pre <- plotdir)

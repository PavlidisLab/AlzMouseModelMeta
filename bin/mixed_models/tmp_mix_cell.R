...
mixedModelAllCellType <- function(rfile_ls=NULL, md_info=NULL, phase, out_dir, NA_filter=c('all', '0.3', 'none'),
    ...
    #' cell_markers_f', e.g. cell_markers_f='../../doc/cell_type_markers/Striatum/Striatum_Spiny.tsv'
    print(Sys.Date())
    ...
    #get the PC1 scaled for each cell type
    ...
    save(array_dat,array_design, df_all, msg, file=paste0(result_dir, "mixed_model_results.Rdata"))
